//! Forwarders command implementation.
//!
//! This module provides the CLI command for listing Splunk deployment clients (forwarders).
//!
//! # What this module handles:
//! - Listing forwarders with pagination support
