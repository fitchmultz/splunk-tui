...
impl SplunkClient {
    ...
    pub async fn list_workload_pools(
        ...
        self.execute_request(
            crate::client::request_executor::RequestPolicy::for_operation("list_workload_pools"),
            |__token| async move {
    ...
    pub async fn list_workload_rules(
        ...
        self.execute_request(
            crate::client::request_executor::RequestPolicy::for_operation("list_workload_rules"),
            |__token| async move {
