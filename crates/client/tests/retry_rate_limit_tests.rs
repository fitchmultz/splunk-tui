//! Rate limiting (429) retry behavior tests.
//!
...
//! - Retry-After header is respected when present (see retry_after_header_tests.rs)
//! - After max retries, MaxRetriesExceeded error is returned
//!
//! # What this does NOT handle
//! - Retry-After header parsing (see retry_after_header_tests.rs)
//! - Authentication-related retries (see retry_auth_tests.rs)
