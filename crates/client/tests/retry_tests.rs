//! Mixed retry scenario and timeout tests.
//!
//! This module contains tests for mixed retry scenarios and timeout handling
//! that don't fit into the more specific retry test categories.
//!
//! # Invariants
//! - Mixed 503 and 429 responses trigger retries with exponential backoff
//! - Timeout errors trigger retry behavior
//!
//! # What this does NOT handle
//! - Rate limiting (429) - see retry_rate_limit_tests.rs
//! - Session auth retry (401/403) - see retry_auth_tests.rs
//! - Retry-After header handling - see retry_header_tests.rs
//! - 5xx server errors - see retry_5xx_tests.rs
