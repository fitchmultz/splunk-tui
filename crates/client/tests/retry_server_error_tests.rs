...
//!
//! # Invariants
//! - 502 (Bad Gateway), 503 (Service Unavailable), 504 (Gateway Timeout) trigger retry
//! - 500 (Internal Server Error) and 501 (Not Implemented) do NOT trigger retry
//! - Retries use exponential backoff (1s, 2s, 4s, ...)
//! - After max retries, MaxRetriesExceeded error is returned
//!
//! # What this does NOT handle
//! - Rate limiting retries (see retry_rate_limit_tests.rs)
//! - Authentication retries (see retry_auth_tests.rs)
//! - Timeout handling (see retry_mixed_and_timeout_tests.rs)
