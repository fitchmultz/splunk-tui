...
use crate::ui::screens::{
    apps, audit, cluster, configs, forwarders, health, indexes, inputs, kvstore, license, lookups,
    macros, multi_instance, overview, roles, saved_searches, search, search_peers, settings, users,
};
use ratatui::{
    Frame,
