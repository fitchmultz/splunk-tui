//! Tests for search result pagination and loading.
//!
//! This module tests:
//! - Search completion state management
//! - Results appending and pagination triggers
//! - Error handling during pagination
//! - Edge cases with unknown total counts
//!
//! ## Invariants
//! - Pagination must trigger when near end of results and more exist
//! - Loading state prevents duplicate fetch requests
//! - Error during pagination preserves existing results
