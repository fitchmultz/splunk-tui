...
//!
//! This module tests:
//! - Validation trigger on input changes
//! - Validation result state updates
//! - Debounce behavior
//! - Input methods that trigger validation (typing, history, backspace, delete)
//!
//! ## Invariants
//! - Validation triggers after debounce period (not immediately)
//! - Validation state clears on new input
//! - History navigation triggers validation for loaded queries
